...
for(i in 1:length(common.states)){
    ...
    plot(ds2.c$epiwk         ,
       ...
       lty=1,
       ylab='Observed/Expected',
       main=paste(states[i], ' Deaths(red),','ILI(blue)' ))
