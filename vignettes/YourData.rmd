---
title: "Using ExcessILI with arbritrary data"
...
We start with a line list of data of all ED visits in a system (1 line per ED
visit). We know the admissions data, the age group, and the state. We also have
flags for whether the individual had influenza like illness (ILI) or a
respiratory code:
...
We will now analyze syndromic surveillance data from emergency departments in
New York City
